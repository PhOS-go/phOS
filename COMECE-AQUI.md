...
Bem-vindo ao **phOS**. Em 5 minutos ele vai conhecer o seu projeto. Siga os 4 passos.

---

## 1. Instalar (uma vez)

No terminal, dentro desta pasta, abra o Claude Code:
...
Quando o `/instalar` terminar, ele te lembra de renomear a pasta `phOS/` pro nome
do seu projeto:
...
Sempre que sentar pra trabalhar, comece com:

```
/abrir
```

Ele carrega tudo que vocês combinaram e te dá um resumo de uma frase pra começar.

## 4. Trabalhar e salvar
...
- **Repete uma tarefa toda semana?** Rode `/mapear-rotinas` e ele transforma em
  comando próprio.
- **Começou um cliente/projeto novo?** Rode `/novo-projeto` pra criar uma pasta
  isolada com contexto dedicado.

Qualquer dúvida sobre o sistema, abra o `README.md`.
