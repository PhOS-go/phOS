...
- **Cor proibida:** gradiente roxo-rosa clichê de IA e azul corporativo genérico

## Tipografia

- **Títulos e destaques:** Space Grotesk (sans geométrica, marcante)
- **Corpo, subtítulos e botões:** Inter
- **Detalhes / labels / código:** JetBrains Mono (mono, dá o toque "sistema")
- **Peso do título:** 700
...
- **Bordas:** 1px sutil em `#1F2A3A`
- **Border-radius dos cards:** 16px
- **Botões:** retângulo arredondado (radius 12px), fundo turquesa, texto escuro
- **Sombras:** suaves e baixas, nunca duras
- **Acento mono:** prefixos tipo `>` ou `/comando` em JetBrains Mono pra reforçar
  a linguagem de sistema

## O que NUNCA fazer

- Gradiente roxo→rosa (cara de template de IA)
- Mais de um destaque de cor por peça
- Emoji em peça institucional séria
- Texto de baixo contraste sobre fundo escuro
...
<!-- Qualquer regra visual específica da sua marca. -->
